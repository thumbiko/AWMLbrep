    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(blank=True, choices=[('London', 'London'), ('Outer London', 'Outer London')], max_length=20, null=True)),
                ...
                ('rental_frequency', models.CharField(blank=True, choices=[('Day', 'Day'), ('Week', 'Week'), ('Month', 'Month')], max_length=20, null=True)),
